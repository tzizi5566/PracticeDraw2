...
public class Practice14MaskFilterView extends View {
  ...
  Bitmap bitmap;
  BlurMaskFilter mNormalBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
  BlurMaskFilter mInnerBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
  BlurMaskFilter mOuterBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
  BlurMaskFilter mSolidBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
